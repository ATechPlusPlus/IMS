...
namespace IMS.Barcode
{
    public partial class frmBarCode : Form
    {
        ...
        private void SetBarCodeValues(Control objLable, DataGridViewRow selectedRow)
        {
            ...
            {
                objLable.Text = selectedRow.Cells["CategoryName"].Value.ToString();
            }
            else if (objLable.Tag.ToString().Trim() == "Brand")
            {
                objLable.Text = selectedRow.Cells["BrandName"].Value.ToString();
