...
namespace IMS.Masters
{
    public partial class Category_Master : Form
    {
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 || e.ColumnIndex >= 0)
            {
                try
                {
                    ...
                    //cmbActiveStatus.SelectedText = dataGridView1.SelectedRows[0].Cells["ActiveStatus"].Value.ToString();
        ...
        private void txtSearchByCategory_TextChanged(object sender, EventArgs e)
        {
            ...
            DataTable dt = ObjDAL.GetDataCol(clsUtility.DBName + ".dbo.CategoryMaster", "ID,CategoryName,CategoryDescription,ActiveStatus", "CategoryName LIKE '%" + txtSearchByCategory.Text + "%'", "ID");
            if (ObjUtil.ValidateTable(dt))
            {
                dataGridView1.DataSource = dt;
            }
